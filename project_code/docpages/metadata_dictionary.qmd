...
The `baptisms` table contains cleaned and standardized records of baptism events extracted from parish registers. Each row represents a unique baptism event with associated attributes such as date, location, and involved individuals.
